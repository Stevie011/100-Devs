...
let candyCalc = (currentLevel, evoLevel) => evoLevel - currentLevel

let bulbasaurLevel = candyCalc(5, 16)
let caterpieLevel = candyCalc(1, 7)
let weedleLevel = candyCalc(1, 7)
...
let farenToCel = f => (f - 32) * 5/9

let canCharBattle = f => farenToCel(f) > 0 ? "charmander can battle " : "no he can't"

console.log(canCharBattle(15))
